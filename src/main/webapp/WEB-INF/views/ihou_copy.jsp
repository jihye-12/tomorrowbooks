...
<ul class="edit_toggle">
  ...
  <div class="flex-div">
    <div class="img-explain">
      <div>
        <span> 당신은 아무 잘못이 없다 | 심리학 </span>
        <time>21시간 전</time>
      </div>
      <img src="/resources/images/book2-1.jpeg" />
      <div>
        <img class="production-tag-scroller__item__image" src="/resources/images/book2-2.jpeg" />
        <img class="production-tag-scroller__item__image" src="/resources/images/book2-3.jpeg" />
        <img class="production-tag-scroller__item__image" src="/resources/images/book3.jpg" />
      </div>
      <p>우울증을 겪고 있다면 추천하고 싶은 책
      </p>
      <p>&nbsp</p>
      <p class="tag">
        #심리 &nbsp #고민 &nbsp #오카다사오리 &nbsp #우울증 &nbsp #자존감 &nbsp #당신은
        &nbsp #아무 &nbsp #잘못이 &nbsp #없다
      </p>
      <p class="tag">#그린인테리어 &nbsp #플랜테리어 &nbsp #거실</p>
      <img class="css-1cqverl e11tzz432" src="/resources/images/book2-2.jpeg" />
      <p>&nbsp</p>
      <p>&nbsp</p>
      <p>&nbsp</p>
      <p>&nbsp</p>
